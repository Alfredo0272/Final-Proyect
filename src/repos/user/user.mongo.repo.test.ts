...
describe('Given UserMongoRepo class', () => {
  ...
  describe('When we instantiate it without errors', () => {
    ...
    test('should return an add beer and update object', async () => {
      const updatedUser = {
        probada: [beer],
      };
      UserModel.findByIdAndUpdate = jest.fn().mockReturnValue({
    ...
    test('should return an add Pub and update object', async () => {
      const updatedUser = {
        visitado: [pub],
      };
      UserModel.findByIdAndUpdate = jest.fn().mockReturnValue({
    ...
    test('should delete a beer from the probadas array', async () => {
    ...
    test('should delete a Pub from the visitado array', async () => {
